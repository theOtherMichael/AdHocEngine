...
#define Assert_NoEntry()   ADHOC_ASSERT_IMPLEMENTATION_NO_ENTRY(true, "Assert_NoEntry() invoked()", "")
#define Assert_NoReentry() ADHOC_ASSERT_IMPLEMENTATION_NO_REENTRY(true, "Assert_NoReentry() invoked twice()", "")

#define Expect_NoEntry()   ADHOC_ASSERT_IMPLEMENTATION_NO_ENTRY(false, "Assert_NoEntry() invoked()", "")
#define Expect_NoReentry() ADHOC_ASSERT_IMPLEMENTATION_NO_REENTRY(false, "Assert_NoReentry() invoked twice()", "")
...
#define Assert_NoEntry_Fmt(fmtString, ...)                                                                             \
    ADHOC_ASSERT_IMPLEMENTATION_NO_ENTRY(true, "Assert_NoEntry() invoked()", fmt::format(fmtString, __VA_ARGS__))
#define Assert_NoReentry_Fmt(fmtString, ...)                                                                           \
    ADHOC_ASSERT_IMPLEMENTATION_NO_REENTRY(                                                                            \
        true, "Assert_NoReentry() invoked twice()", fmt::format(fmtString, __VA_ARGS__))

#define Expect_NoEntry_Fmt(fmtString, ...)                                                                             \
    ADHOC_ASSERT_IMPLEMENTATION_NO_ENTRY(false, "Assert_NoEntry() invoked()", fmt::format(fmtString, __VA_ARGS__))
#define Expect_NoReentry_Fmt(fmtString, ...)                                                                           \
    ADHOC_ASSERT_IMPLEMENTATION_NO_REENTRY(                                                                            \
        false, "Assert_NoReentry() invoked twice()", fmt::format(fmtString, __VA_ARGS__))
